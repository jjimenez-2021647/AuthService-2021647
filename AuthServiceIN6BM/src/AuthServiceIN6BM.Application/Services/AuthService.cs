    ...
    ILogger<AuthService> logger) : IAuthService
{
    ...
    public async Task<AuthResponseDto> LoginAsync(LoginDto loginDto)
    {
        ...
        if (loginDto.EmailOurUsername.Contains('@'))
        {
            // Es un email
            user = await userRepository.GetByEmailAsync(loginDto.EmailOurUsername.ToLowerInvariant());
        }
        else
        {
            // Es un username
            user = await userRepository.GetByUsernameAsync(loginDto.EmailOurUsername);
        }
